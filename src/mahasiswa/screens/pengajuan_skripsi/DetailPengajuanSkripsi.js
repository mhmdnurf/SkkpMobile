...
const DetailPengajuanSkripsi = ({route, navigation}) => {
  ...
  return (
    <ScrollView
      ...
      <Text style={styles.title}>{pengajuanData.topik}</Text>
      {pengajuanData ? (
        <>
          <View style={styles.detailContainer}>
            ...
            <TouchableOpacity
              ...
              <Text style={styles.linkButtonText}>Slip Pembayaran Skripsi</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={styles.linkButton}
              onPress={() => handleOpenLink(pengajuanData.sertifikatPSPT)}>
